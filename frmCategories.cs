...
namespace BookStore.UI
{
    public partial class frmCategories : Form
    {
        ...
        CategoriesDLL dal = new CategoriesDLL();
        userDLL = new userDLL();

        private void btnAdd_Click(object sender, EventArgs e)
        {
            //Get the vlues from Category Form
            c.Book Genre ID = txtTitle.Text;
            c.Book Genre Description = txtDescription.Text;
